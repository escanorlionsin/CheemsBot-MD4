...
global.mess = {
    ...
    wait: 'انتظر ♡',
    linkm: 'ضع الرابط من فضلك ♡',
    error: 'خطأ',
    endLimit: 'Your Daily Limit Has Expired, The Limit Will Be Reset Every 12 Hours',
    ban: '𝐄𝐒𝐂𝐀𝐍𝐎𝐑 لقد تم حظرك من قبل المالك ، إذا كنت تريد أن تكون غير محظور ، مالك الدردشة.',
    nsfw: 'لم يتم تنشيط ميزة nsfw ، يرجى الاتصال بالمسؤول 𝐄𝐒𝐂𝐀𝐍𝐎𝐑 للتفعيل',
    banChat: 'تم حظر الروبوت في هذه المجموعة ، يرجى الاتصال بالمالك 𝐄𝐒𝐂𝐀𝐍𝐎𝐑 لإلغاء الحظر'
}
    global.limitawal = {
    premium: "Infinity",
    free: 12,
